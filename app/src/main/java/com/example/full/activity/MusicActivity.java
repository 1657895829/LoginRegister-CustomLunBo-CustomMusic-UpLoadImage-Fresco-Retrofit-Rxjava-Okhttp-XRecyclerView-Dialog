...
import com.example.full.model.MusicData;
import com.example.full.service.MusicService;
import com.example.full.utils.DisplayUtil;
import com.example.full.utils.FastBlurUtil;
import com.example.full.widget.BackgourndAnimationRelativeLayout;
import com.example.full.widget.Recordview;
import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;
import static com.example.full.widget.Recordview.DURATION_NEEDLE_ANIAMTOR;

/**
 *  使用MediaPlayer播放本地音乐
 */
public class MusicActivity extends AppCompatActivity implements Recordview.IPlayInfo, View.OnClickListener {
